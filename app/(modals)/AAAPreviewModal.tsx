 ...
 * AAAPreviewModal.tsx
 *
 * Renders the AAA document inside a full-screen modal with print and
 * download actions.  Mirrors the chrome of CanvassPreviewModal (green header,
 * info strip, WebView, footer) so both preview modals feel consistent.
 *
    ...
    >
      <View style={{ flex: 1, backgroundColor: "#f9fafb" }}>
        ...
        <View style={{
          ...
          {[
            { icon: "calendar-today" as const, label: "Date",   value: date   },
            { icon: "location-city"  as const, label: "Office", value: office },
            { icon: "article"        as const, label: "PR No.", value: prNo   },
          ].map((item) => (
        ...
        <View style={{
          ...
          <Text style={{ fontSize: 11, color: "#047857" }}>
            This is a preview of the DAR Abstract of Price Quotations.
          </Text>
        </View>
