...
export interface BACResolutionPreviewProps {
  data: BACResolutionData;
  style?: ViewStyle;
}

/**
 * React component that renders a preview of the BAC Resolution document.
 */
export function BACResolutionPreview({
  data,
  style,
}: BACResolutionPreviewProps): React.ReactElement {
  const html = buildBACResolutionHTML(data);

  const handlePrint = () => {
    console.log("Print BAC Resolution");
  };

  const handleDownload = () => {
    console.log("Share BAC Resolution");
  };
